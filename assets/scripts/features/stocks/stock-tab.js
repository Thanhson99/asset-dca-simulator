...
import { formatDisplayDate as formatDate, nextIsoDate, previousIsoDate, toIsoDate } from "../../shared/dates.js";
...
import { formatShares, formatStockMoney as formatMoney } from "./stock-format.js";
import { renderStockSimulationSummary } from "./stock-summary.js";
...
function renderSimulationSummary(rows, filters) {
  renderStockSimulationSummary({
    container: elements.simulationSummary,
    rows,
    filters,
    primaryColor: elements.lineColor.value,
  });
}
